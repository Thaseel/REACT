...
const UpdatePlace = () => {
    ...
    return <form className="place-form" onSubmit={PlaceUpdateSubmitHandler}>
        ...
        <Input id="description" element="textarea" label="Description" validators={[VALIDATOR_MINLENGTH(5)]} errorText="please enter a description" onInput={inputHandler} initialValue={formState.inputs.description.value} initialValid={formState.inputs.description.isValid} />
